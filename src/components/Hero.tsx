    ...
    <div className="relative">
      ...
      >
        ...
        <motion.div
          ...
          className="pointer-events-none select-none absolute top-[27%] left-1/2 -translate-x-1/2 z-20 text-center font-extrabold tracking-tight leading-[0.92] w-auto flex flex-col items-center gap-1"
        >
